...
By default, vlcd will dump mempool on shutdown and
...
class MempoolPersistTest(VlcTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give vlcd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent vlcd from writing mempool.dat to disk. Verify that `savemempool` fails")
