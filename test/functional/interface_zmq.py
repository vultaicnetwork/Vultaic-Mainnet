...
import os
import struct
from test_framework.test_framework import VlcTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(VlcTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that vlc has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("vlcd has not been built with zmq enabled.")
