...
class WalletTest(VlcTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 vlc from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 vlc with subtract fee from amount
        ...
        # Sendmany 10 vlc with subtract fee from amount
