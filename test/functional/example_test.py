...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the VlcTestFramework
    pass

class ExampleTest(VlcTestFramework):
    # Each functional test is a subclass of the VlcTestFramework class.
    ...
    def custom_method(self):
        ...
        VlcTestFramework class so other tests can use it."""
