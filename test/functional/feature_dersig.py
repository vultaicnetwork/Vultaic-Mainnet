...
class BIP66Test(VlcTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # vlcd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and vlcd produces more specific reject
            # reasons.
