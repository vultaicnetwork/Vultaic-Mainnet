...
class AssetTest(VlcTestFramework):
    ...
    def big_test(self):
        ...
        n0.listassets(asset="VLC*", verbose=False, count=2, start=-2)
        ...
        vlc_assets = n0.listassets(asset="VLC*", verbose=False, count=2, start=-2)
        assert_equal(len(vlc_assets), 2)
        assert_equal(vlc_assets[0], "VLC2")
        assert_equal(vlc_assets[1], "VLC3")
        self.sync_all()
