...
class TestVlcCli(VlcTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `vlc-cli getinfo`")
        ...
        self.log.info("Compare responses from `vlc-cli -getinfo` and the RPCs data is retrieved from.")
