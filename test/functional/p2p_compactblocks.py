...
# TestNode: A peer we use to send messages to vlcd, and store responses.
...
class CompactBlocksTest(VlcTestFramework):
    ...
    # This test actually causes vlcd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that vlcd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for vlcd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # vlcd will not send blocktxn responses for blocks whose height is
