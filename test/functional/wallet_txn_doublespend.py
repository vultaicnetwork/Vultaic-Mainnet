...
class TxnMallTest(VlcTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 vlc:
        ...
        # First: use raw transaction API to send 1240 vlc to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 vlc coin each
        ...
        # Node0's balance should be starting balance, plus 50vlc for another
        ...
        # Node0's total balance should be starting balance, plus 100vlc for 
