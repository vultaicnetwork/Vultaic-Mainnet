...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<VlcAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_vlc-qt -platform xcb      # Linux
//     src/qt/test/test_vlc-qt -platform windows  # Windows
//     src/qt/test/test_vlc-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = VlcUnits::formatWithUnit(unit, balance, false, VlcUnits::separatorAlways);
    ...
    // Amount input
    VlcAmountField* amountInput = receiveCoinsDialog.findChild<VlcAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: vlc:")) != -1);
