...
void WalletView::setVlcGUI(VlcGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? VlcGUI::HD44_ENABLED : _walletModel->hdEnabled() ? VlcGUI::HD_ENABLED : VlcGUI::HD_DISABLED);
