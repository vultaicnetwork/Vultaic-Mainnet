...
#include "config/vlc-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatVlcURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + VlcUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatVlcURI(info));
}
