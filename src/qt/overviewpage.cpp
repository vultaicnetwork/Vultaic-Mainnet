...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(VlcUnits::vlc),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->vlcBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->vlcBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(VlcUnits::formatWithUnit(unit, balance, false, VlcUnits::separatorAlways));
    ui->labelUnconfirmed->setText(VlcUnits::formatWithUnit(unit, unconfirmedBalance, false, VlcUnits::separatorAlways));
    ui->labelImmature->setText(VlcUnits::formatWithUnit(unit, immatureBalance, false, VlcUnits::separatorAlways));
    ui->labelTotal->setText(VlcUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, VlcUnits::separatorAlways));
    ui->labelWatchAvailable->setText(VlcUnits::formatWithUnit(unit, watchOnlyBalance, false, VlcUnits::separatorAlways));
    ui->labelWatchPending->setText(VlcUnits::formatWithUnit(unit, watchUnconfBalance, false, VlcUnits::separatorAlways));
    ui->labelWatchImmature->setText(VlcUnits::formatWithUnit(unit, watchImmatureBalance, false, VlcUnits::separatorAlways));
    ui->labelWatchTotal->setText(VlcUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, VlcUnits::separatorAlways));
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the vlc balance grid from expanding and looking terrible when asset balance is hidden
