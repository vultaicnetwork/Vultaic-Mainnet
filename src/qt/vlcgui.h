...
#ifndef VLC_QT_VlcGUI_H
#define VLC_QT_VlcGUI_H
...
/**
  vlc GUI main class. This class represents the main window of the vlc UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class VlcGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit VlcGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~VlcGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a vlc wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
