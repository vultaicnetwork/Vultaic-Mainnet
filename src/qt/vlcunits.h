...
#ifndef VLC_QT_VLCUNITS_H
#define VLC_QT_VLCUNITS_H
...
/** vlc unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class VlcUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit VlcUnits(QObject *parent);
...
typedef VlcUnits::Unit VlcUnit;

#endif // VLC_QT_VLCUNITS_H
