...
#ifndef VLC_QT_GUIUTIL_H
#define VLC_QT_GUIUTIL_H
...
/** Utility functions used by the vlc Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "vlc:" URI into recipient object, return true on successful parsing
