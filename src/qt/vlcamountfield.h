...
#ifndef VLC_QT_VlcAmountField_H
#define VLC_QT_VlcAmountField_H
...
/** Widget for entering vlc amounts.
  */
class VlcAmountField: public QWidget
{
    Q_OBJECT
...
public:
    explicit VlcAmountField(QWidget *parent = 0);
