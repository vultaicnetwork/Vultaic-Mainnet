...
#ifndef VLC_TEST_SCRIPTNUM10_H
#define VLC_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Vlc Core 0.10.0, for cross-comparison.
 */
public:
