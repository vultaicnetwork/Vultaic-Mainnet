...
#ifndef VLCCOIN_ASSET_PROTOCOL_H
#define VLCCOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_VLC_ASSET vlcQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_VLC_ASSET vlcO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_VLC_ASSET vlcR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_VLC_ASSET vlcT
...
#endif //VLCCOIN_ASSET_PROTOCOL_H
