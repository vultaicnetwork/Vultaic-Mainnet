...
#ifndef VLC_SCRIPT_STANDARD_H
#define VLC_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_VLC_ASSET script that carries data
    /** VLC END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a vlc address
 */
...
/**
 * Generate a Vlc scriptPubKey for the given CTxDestination. Returns a P2PKH
