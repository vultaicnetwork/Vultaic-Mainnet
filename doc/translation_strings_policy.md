...
This document provides guidelines for internationalization of the VLC Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `vlc_en.ts` remains unchanged.
