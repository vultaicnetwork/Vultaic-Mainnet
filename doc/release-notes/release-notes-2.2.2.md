VLC Core version *2.2.2* is now available!!
==============

  <https://github.com/VLCProject/VLCcoin/releases/tag/v2.2.2>
...
- Enhancements for VLCcoin Dev Kit and Mobile Wallet Support
...
Changelog available here: <https://github.com/VLCProject/VLCcoin/commits/release_2.2.2>
