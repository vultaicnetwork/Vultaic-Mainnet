VLC Core version *2.1.0* is now available!!
==============

  <https://github.com/VLCProject/VLCcoin/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/VLCProject/VLCcoin/commits/release_2.1.0>
